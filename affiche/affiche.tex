...
\begin{minipage}[b]{4cm}
	 \centering
    \includegraphics[width=\linewidth]{logopass.jpg}\\
...
\begin{minipage}[b]{4cm}
	 \centering
    \includegraphics[width=\linewidth]{logobellu2.png}
	 {\tiny \url{www.co-belluard.ch}}
\end{minipage}%\vfill
\begin{center}
\end{center}\vspace{-2em}
\begin{minipage}[c]{5cm}
    \includegraphics[width=\linewidth]{sav04.jpg}
\end{minipage}\hfill
\begin{minipage}[c]{8.5cm}\centering\huge
   par la vente de\\ \sc{savons d'Alep}\\ 7.-- pièce
\end{minipage}\hfill
\begin{minipage}[c]{5cm}
    \includegraphics[width=\linewidth]{sav03.jpg}
\end{minipage}\vfill
